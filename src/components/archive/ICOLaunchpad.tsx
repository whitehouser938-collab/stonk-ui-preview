          ...
          <div className="md:hidden">
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-gray-900 border-gray-700 text-gray-400">
                <DropdownMenuItem
                  onClick={() => setSelectedView("IPO LAUNCHPAD")}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("prospectus", e.target.value)
                      }
                      className="w-full p-2 bg-black border border-gray-600 text-white text-xs sm:text-sm font-mono"
                    />
                  </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("underwriters", e.target.value)
                    }
                    className="w-full p-2 bg-black border border-gray-600 text-white text-xs sm:text-sm font-mono"
                  />
                </div>
            ...
            {currentStep === 3 && (
              <div className="space-y-3">
                ...
                <div className="bg-amber-900/20 border border-amber-700 p-3">
                  <div className="text-amber-400 font-bold mb-2 text-sm sm:text-base">
                  ...
                  <div className="space-y-2 text-xs sm:text-sm">
                    <div className="flex items-start">
                      ...
                      <span className="text-gray-300">
                        SEC Form S-1 Registration Statement filed
                      </span>
                    </div>
                    <div className="flex items-start">
                      <input
                    ...
                    <div className="flex items-start">
                      ...
                      />
                      <span className="text-gray-300">
                        Underwriter agreements executed
                      </span>
                    </div>
                    <div className="flex items-start">
                      <input
                      ...
                      />
                      <span className="text-gray-300">
                        Lock-up agreements with insiders
                      </span>
                    </div>
                    <div className="flex items-start">
                      <input
                ...
                <div className="bg-orange-900/20 border border-orange-700 p-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs sm:text-sm">
                    <div className="flex flex-col sm:flex-row sm:justify-between">
                      ...
                      <span className="text-white sm:ml-2 break-words">
                        {formData.name || "N/A"}
                      </span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between">
                      ...
                      <span className="text-white sm:ml-2">
                        {formData.totalSupply || "N/A"}
                      </span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between">
                      <span className="text-gray-400">Price Range:</span>
                      <span className="text-white sm:ml-2">
                        {formData.priceRange || "N/A"}
                      </span>
                    </div>
                    <div className="flex flex-col sm:flex-row sm:justify-between">
