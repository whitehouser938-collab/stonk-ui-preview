...
export function TopPerformers() {
  ...
  return (
    <div className="text-gray-100 text-xs">
      {/* Top Time Bar */}
      <div className="bg-bg-card border-b border-orange-400/30 p-2 flex flex-wrap justify-between items-center gap-2">
      ...
      <div className="space-y-2 p-1">
        ...
        <div className="bg-bg-card border border-gray-700 p-3">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div className="flex items-center space-x-2 sm:space-x-4">
              <h2 className="text-base sm:text-xl font-bold text-orange-400">LEADERBOARD</h2>
                ...
                <div className="flex space-x-1">
                  {timeframes.map((tf) => (
                    <Button
                      ...
                      className={cn(
                        "px-2 py-1 text-xs",
                        selectedTimeframe === tf.key ? "bg-orange-500" : "bg-gray-700"
                      )}
                    >
                      {tf.label}
                    </Button>
            ...
            <Card key={performer.symbol} className="bg-bg-card border-gray-700 p-3">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-orange-400 font-mono">{formatNumber(performer.volume)}</span>
                </div>
                <div className="flex justify-between">
            ...
            <TableBody>
              {sortedPerformers.slice(0, 20).map((performer, index) => (
                ...
                >
                  ...
                  <TableCell className="p-1 text-right text-orange-400 text-xs font-mono">
        ...
        <div className="bg-bg-card p-2 sm:p-3 text-xs border border-gray-700">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
            <div className="flex flex-col sm:flex-row space-y-1 sm:space-y-0 sm:space-x-6 text-xs sm:text-sm">
              <span className="text-gray-400">TOTAL TRACKED: <span className="text-orange-400 font-mono">1,247</span></span>
            ...
            <div className="flex flex-col sm:flex-row space-y-1 sm:space-y-0 sm:space-x-6 text-xs sm:text-sm">
              ...
              <span className="text-gray-400">LAST UPDATE: <span className="text-orange-400 font-mono">{new Date().toLocaleTimeString()}</span></span>
            </div>
          </div>
        </div>
      </div>
