    ...
    return (
      <div className={`text-center py-4 ${className}`}>
        ...
        <Button
          ...
          variant="outline"
          size="sm"
          className="border-orange-500/30 bg-orange-600/10 text-orange-400 hover:text-orange-200 hover:bg-orange-800/10 hover:border-orange-300/50"
        >
          {actionText}
        </Button>
      </div>
    ...
    <Card className={`bg-gray-900 border-gray-700 ${className}`}>
      ...
      <CardContent className="text-center">
        <Button
          ...
          variant="outline"
          size="lg"
          className="border-orange-500/30 bg-orange-600/10 text-orange-400 hover:text-orange-200 hover:bg-orange-800/10 hover:border-orange-300/50 transition-all duration-200"
        >
