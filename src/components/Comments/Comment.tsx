        ...
        {isEditing ? (
          <div className="mb-1">
            <textarea
              ...
              className="w-full bg-card border border-gray-600 rounded p-2 text-sm text-gray-200 placeholder-gray-500 focus:outline-none focus:border-orange-400 resize-none font-sans"
              rows={3}
              maxLength={1000}
            />
